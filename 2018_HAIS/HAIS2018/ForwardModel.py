...
class ForwardModel(object):
    ...
    def predictedState(self, bax_l_action, (bax_l_pos, bax_l_angle, ball_pos, ball_situation, balise1_pos, balise2_pos), w=75, w_act=20,
                       h=60):
        ...
        :param balise1_pos: Tuple containing the position (x, y) of the center of the balise 1
        :param balise2_pos: Tuple containing the position (x, y) of the center of the balise 2
        ...
        sens = self.get_sensorization(bax_l_act_new_pos, ball_new_pos, balise1_pos, balise2_pos)
        return sens
    ...
    def get_sensorization(self, baxter_l_act_pos, ball_pos, balise1_pos, balise2_pos):
        ...
        dist_baxt_larm_balise1 = self.get_distance(baxter_l_act_pos, balise1_pos)
        dist_baxt_larm_balise2 = self.get_distance(baxter_l_act_pos, balise2_pos)
