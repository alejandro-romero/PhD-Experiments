...
class Sim(object):
    ...
    def __init__(self):
        ...
        # self.box1 = plt.Rectangle((1800, 650), 80, 80, fc='y', linewidth=3.5, label='box1')
        # self.box1 = plt.Rectangle((1800, 530), 80, 80, fc='y', linewidth=3.5, label='box1')
        self.box1 = plt.Rectangle((1800, 500), 80, 80, fc='y', linewidth=3.5, label='box1')
        ...
        self.balise1 = plt.Rectangle((1800, 700), 40, 40, fc='cyan', hatch='//', linewidth=1.5, label='balise1')
        self.balise2 = plt.Rectangle((1600, 700), 40, 40, fc='orange', hatch='//', linewidth=1.5, label='balise2')
        ...
        self.ball_position = 'baxter_larm'#None  # Indicates where is the ball: robobo, baxter_larm, bater_rarm, box1, box2 or None
        ...
        self.balise1_set_pos((self.box1_get_pos()[0]-500, self.box1_get_pos()[1]))
        self.ax.add_patch(self.balise1)
        self.balise2_set_pos((self.box1_get_pos()[0] + 500, self.box1_get_pos()[1]))
        self.ax.add_patch(self.balise2)
    ...
    def balise1_set_pos(self, (x, y)):
        """Set the box1 center position"""
        self.balise1.xy = (x - self.balise1.get_width() / 2, y - self.balise1.get_height() / 2)
        # self.fig.canvas.draw()

    def balise2_set_pos(self, (x, y)):
        """Set the box1 center position"""
        self.balise2.xy = (x - self.balise2.get_width() / 2, y - self.balise2.get_height() / 2)
        # self.fig.canvas.draw()
    ...
    def balise1_get_pos(self):
        """Return the position of the center of the box1"""
        return tuple(map(sum, zip(self.balise1.xy, (self.balise1.get_width() / 2, self.balise1.get_height() / 2))))

    def balise2_get_pos(self):
        """Return the position of the center of the box1"""
        return tuple(map(sum, zip(self.balise2.xy, (self.balise2.get_width() / 2, self.balise2.get_height() / 2))))
    ...
    def move_baxter_larm(self, vel=25):
    ...
    def baxter_larm_action(self, relative_angle, vel=25):
    ...
    def get_sensorization(self):
        ...
        dist_baxt_larm_balise1 = self.get_distance(self.baxter_larm_act_get_pos(), self.balise1_get_pos())
        dist_baxt_larm_balise2 = self.get_distance(self.baxter_larm_act_get_pos(), self.balise2_get_pos())

        # return dist_baxt_larm_ball, dist_baxt_larm_balise1, dist_baxt_larm_balise2
        return dist_baxt_larm_balise1, dist_baxt_larm_balise2
    ...
    def world_rules(self):
        ...
        if dist_ball_box1 < min_dist_box:  # distance ball-box1
            # if self.ball_position == 'baxter_larm':
    ...
    def restart_scenario(self):
        ...
        self.baxter_larm_set_pos((np.random.randint(1250, 2400), np.random.randint(50, 800)))

        self.ball_set_pos(self.baxter_larm_act_get_pos())
        self.ball_position = 'baxter_larm'

        # self.box1_set_pos((np.random.randint(1250+200, 2400-200), np.random.randint(700, 800)))
        # self.box1_set_pos((np.random.randint(1250 + 250, 2400 - 250), np.random.randint(50, 800)))
        # self.balise1_set_pos((self.box1_get_pos()[0]-250, self.box1_get_pos()[1]))
        # self.balise2_set_pos((self.box1_get_pos()[0] + 250, self.box1_get_pos()[1]))
