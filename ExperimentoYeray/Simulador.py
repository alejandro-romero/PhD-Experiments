...
class Sim(object):
    ...
    def __init__(self):
        ...
        self.box1 = plt.Rectangle((1600, 500), 67, 67, fc='y', linewidth=3.5, label='box1')
    ...
    # def move_robobo(self, vel=10):
    #     """Move Robobo! wih a specific velocity (default 10)"""
    ...
    def get_sensorization(self):
        ...
        return dist_baxt_larm_ball, dist_ball_box1  # ,reward
    ...
    def restart_scenario(self):
        self.ball_set_pos((np.random.randint(1250, 2400), np.random.randint(50, 800)))
