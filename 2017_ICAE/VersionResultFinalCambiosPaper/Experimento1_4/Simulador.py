...
class Sim(object):
    ...
    def baxter_larm_action(self, relative_angle, iterations, vel=20):
    ...
    def robobo_action(self, relative_angle, iterations, vel=20):
    ...
    def apply_action(self, relative_angles, iterations, vel_rob=25, vel_baxt=25):
        """Move robobo and baxter left arm with a specific angle and velocity (default 20)"""
        self.robobo_action(relative_angles[0], iterations, vel_rob)
        self.baxter_larm_action(relative_angles[1], iterations, vel_baxt)
        # self.baxter_state_space()
    ...
    def world_rules(self, iterations):
        ...
        if sens[2] < min_dist_box and (self.ball_position == 'baxter_larm' or iterations >= 51800):#40000):  # distance ball-box1
            # if self.ball_position == 'baxter_larm':
