...
class DistancesCertainty(object):
    ...
    def DrawPoints(self):
        ...
        # Subfigure 1
        ax1 = plt.subplot(241)
        ax1.set_xlim(self.Linf[0], 1200)
        ax1.set_ylim(self.Linf[0], 1200)
        # ax1.set_xlim(self.Linf[0], self.Lsup[0])
        # ax1.set_ylim(self.Linf[0], self.Lsup[0])
        ax1.set_xlabel('dCR')
        ax1.set_ylabel('dCX')
        ax1.set_title("dCB = 0")
        a = np.arange(self.Linf[0], self.Lsup[0], 30)
        a = a.tolist()
        ...
        ax2.set_xlim(self.Linf[0], 1200)
        ax2.set_ylim(self.Linf[0], 1200)
        ax2.set_title("dCB = 400")
        ax2.set_xlabel('dCR')
        ax2.set_ylabel('dCX')
        a = np.arange(self.Linf[0], self.Lsup[0], 30)
        a = a.tolist()
        for i in range(len(a)):  # range(number):
            for j in range(len(a)):
                ...
                z = a[j]  # np.random.uniform(self.Linf[0], self.Lsup[0])
                # Obtengo certeza para ese x,y
                certainty = self.getCertaintyValue((x, 400, z))
                # Establezco el color del punto en funcion del valor de certeza
                if certainty < 0:
                    # color = 'yellow'
                    color='red'
        ...
        ax3.set_xlim(self.Linf[0], 1200)
        ax3.set_ylim(self.Linf[0], 1200)
        ax3.set_title("dCB = 800")
        ax3.set_xlabel('dCR')
        ax3.set_ylabel('dCX')
        a = np.arange(self.Linf[0], self.Lsup[0], 30)
        a = a.tolist()
        for i in range(len(a)):  # range(number):
            for j in range(len(a)):
                ...
                z = a[j]  # np.random.uniform(self.Linf[0], self.Lsup[0])
                # Obtengo certeza para ese x,y
                certainty = self.getCertaintyValue((x, 800, z))
                # Establezco el color del punto en funcion del valor de certeza
                if certainty < 0:
                    # color = 'yellow'
                    color='red'
        ...
        ax4.set_xlim(self.Linf[0], 1200)
        ax4.set_ylim(self.Linf[0], 1200)
        ax4.set_title("dCB = 1200")
        ax4.set_xlabel('dCR')
        ax4.set_ylabel('dCX')
        a = np.arange(self.Linf[0], self.Lsup[0], 30)
        a = a.tolist()
        for i in range(len(a)):  # range(number):
            for j in range(len(a)):
                ...
                z = a[j]  # np.random.uniform(self.Linf[0], self.Lsup[0])
                # Obtengo certeza para ese x,y
                certainty = self.getCertaintyValue((x, 1200, z))
                # Establezco el color del punto en funcion del valor de certeza
                if certainty < 0:
                    # color = 'yellow'
                    color='red'
        ...
        # Subfigure 5
        ax5 = plt.subplot(245)
        ax5.set_xlim(self.Linf[1], 1200)#self.Lsup[1])
        ax5.set_ylim(self.Linf[1], 1200)#self.Lsup[1])
        ax5.set_title("dCR = 0")
        ax5.set_xlabel('dCB')
        ax5.set_ylabel('dCX')
        a = np.arange(self.Linf[1], self.Lsup[1], 30)
        a = a.tolist()
        for i in range(len(a)):  # range(number):
            for j in range(len(a)):
                x = a[i]  # np.random.uniform(self.Linf[0], self.Lsup[0])
        ...
        ax6 = plt.subplot(246)
        # ax6.axis('off')
        ax6.set_xlim(self.Linf[1], 1200)#self.Lsup[1])
        ax6.set_ylim(self.Linf[1], 1200)#self.Lsup[1])
        ax6.set_title("dCR = 400")
        ax6.set_xlabel('dCB')
        ax6.set_ylabel('dCX')
        a = np.arange(self.Linf[1], self.Lsup[1], 30)
        a = a.tolist()
        for i in range(len(a)):  # range(number):
            for j in range(len(a)):
                ...
                z = a[j]  # np.random.uniform(self.Linf[0], self.Lsup[0])
                # Obtengo certeza para ese x,y
                certainty = self.getCertaintyValue((400, x, z))
                # Establezco el color del punto en funcion del valor de certeza
                if certainty < 0:
                    # color = 'yellow'
                    color='red'
        ...
        ax7 = plt.subplot(247)
        # ax7.axis('off')
        ax7.set_xlim(self.Linf[1], 1200)#self.Lsup[1])
        ax7.set_ylim(self.Linf[1], 1200)#self.Lsup[1])
        ax7.set_title("dCR = 800")
        ax7.set_xlabel('dCB')
        ax7.set_ylabel('dCX')
        a = np.arange(self.Linf[1], self.Lsup[1], 30)
        a = a.tolist()
        for i in range(len(a)):  # range(number):
            for j in range(len(a)):
                ...
                z = a[j]  # np.random.uniform(self.Linf[0], self.Lsup[0])
                # Obtengo certeza para ese x,y
                certainty = self.getCertaintyValue((800, x, z))
                # Establezco el color del punto en funcion del valor de certeza
                if certainty < 0:
                    # color = 'yellow'
                    color='red'
        ...
        ax8 = plt.subplot(248)
        # ax8.axis('off')
        ax8.set_xlim(self.Linf[1], 1200)#self.Lsup[1])
        ax8.set_ylim(self.Linf[1], 1200)#self.Lsup[1])
        ax8.set_title("dCR = 1200")
        ax8.set_xlabel('dCB')
        ax8.set_ylabel('dCX')
        a = np.arange(self.Linf[1], self.Lsup[1], 30)
        a = a.tolist()
        for i in range(len(a)):  # range(number):
            for j in range(len(a)):
                ...
                z = a[j]  # np.random.uniform(self.Linf[0], self.Lsup[0])
                # Obtengo certeza para ese x,y
                certainty = self.getCertaintyValue((1200, x, z))
                # Establezco el color del punto en funcion del valor de certeza
                if certainty < 0:
                    # color = 'yellow'
                    color='red'
    ...
    def getCertaintyMatrix(self):
        ...
        a = np.arange(self.Linf[1], self.Lsup[1], 100)
        a = a.tolist()
        certaintyMatrix = np.zeros((len(a), len(a), len(a)))
        # certaintyMatrix.append([])
        # certaintyMatrix[0].append([])
        for i in range(len(a)):  # range(number):
            # certaintyMatrixAux = []
            for j in range(len(a)):
                # certaintyMatrixAux2 = []
                for k in range(len(a)):
                    x = a[i]  # np.random.uniform(self.Linf[0], self.Lsup[0])
                    y = a[j]
                    z = a[k]  # np.random.uniform(self.Linf[0], self.Lsup[0])
                    # Obtengo certeza para ese x,y
                    certainty = self.getCertaintyValue((x, y, z))
                    # print certainty
                    # Si hay certeza guardo un uno. En otro caso un cero
                    if certainty > 0.1:
                        certaintyMatrix[i][j][k] = 1
                        # certaintyMatrixAux2.append(1)
                    else:
                        certaintyMatrix[i][j][k] = 0
                        # certaintyMatrixAux2.append(0)
                # certaintyMatrixAux.append(certaintyMatrixAux2)
            # certaintyMatrix.append(certaintyMatrixAux)
    ...
    def DrawCertaintyMap(self):
        ...
        for i in range(len(a)):
            for j in range(len(a)):
                p = a[i]
                q = a[j]
                certainty[i][j] = max(0, self.getCertaintyValue((p, 0, q)))
