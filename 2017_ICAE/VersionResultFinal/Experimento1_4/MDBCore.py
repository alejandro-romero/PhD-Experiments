...
class MDBCore(object):
    ...
    def plotGraphs(self):
        ...
        ax.set_xlabel('Number of rewards', size=15.0)
    ...
    def saveData(self):  # , action, seed):
        f = open('SimulationDataLongExecTracesVF_VF.pckl', 'wb')
    ...
    def loadData(self):
        f = open('SimulationDataLongExecTracesVF.pckl', 'rb')  # SimulationDataLongExecBis2 SimulationDataRealFinal379repairedNorm
