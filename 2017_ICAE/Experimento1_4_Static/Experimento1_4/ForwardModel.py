...
class ForwardModel(object):
    ...
    def predictedState(self, (rob_action, bax_l_action), (bax_l_pos, bax_l_angle, rob_pos, rob_angle, ball_pos, ball_situation, box1_pos), w=75, w_act=20,
                       h=60):
        ...
        # if ball_situation == 'baxter_larm':
        #     rob_act_new_pos = rob_pos
        # else:
