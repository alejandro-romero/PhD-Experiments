...
class CorrelationsManager(object):
    """Class that represents the Correlations Manager module.
        This module identifies when new SURs are needed and contains the set of existing SURs.

        It contains a list with all the existing SURs.

        It also chooses the active SUR and gives the value of the reward based on this active SUR.
        """
